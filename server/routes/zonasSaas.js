    ...
    *{box-sizing:border-box;}
    ...
    body{
      background:
        ...
        radial-gradient(circle at 86% 14%, rgba(99,102,241,.18), transparent 28%),
    ...
    .hero,.cabecera,.header,.top-panel{
      ...
      background:
        linear-gradient(135deg,rgba(17,24,39,.96),rgba(67,56,202,.66)),
        radial-gradient(circle at 92% 18%, rgba(245,158,11,.58), transparent 32%) !important;
