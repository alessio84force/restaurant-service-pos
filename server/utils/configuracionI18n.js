...
function textosConfiguracion(idiomaValor) {
  ...
  const textos = {
    ...
    "pt-br": {
          ...
          "abrirPos": "Abrir POS",
          "cerrarSesion": "Sair",
          "panelDescripcion": "Painel compacto para preparar o restaurante, revisar o faturamento, configurar o serviço e gerenciar as principais ferramentas.",
          "estado": "Status",
          "datosFiscales": "Dados fiscais",
          "completos": "Completos",
          ...
          "productos": "Produtos",
          "usuarios": "Usuários",
          "pedidosAbiertos": "Pedidos abertos",
          "herramientas": "Ferramentas do restaurante",
          "vistaCompacta": "Tudo em uma visão compacta",
          "restauranteId": "ID do restaurante",
          "usuario": "Usuário",
          "abrirPosTexto": "Entre no salão e gerencie mesas, pedidos e pagamentos.",
          "servicio": "Serviço",
          "restaurante": "Restaurante",
          "restauranteTexto": "Dados fiscais, logotipo, comprovantes e faturamento.",
          "productosTexto": "Categorias, preços e produtos disponíveis.",
          "menu": "Cardápio",
          "mesasTexto": "Salões, áreas e numeração das mesas.",
          "sala": "Salão",
          "destinos": "Destinos",
          "destinosTexto": "Bar, cozinha e destinos personalizados.",
          "comandas": "Comandas",
          "impresoras": "Impressoras",
          "impresorasTexto": "Comprovante, bar, cozinha e testes de impressão.",
          "impresion": "Impressão",
          "caja": "Caixa",
          "cajaTexto": "Fechamentos diários e mensais e pagamentos.",
          "control": "Controle",
          "reportes": "Relatórios",
          "reportesTexto": "Exportações CSV e análise do restaurante.",
          "datos": "Dados",
          "backups": "Backups",
          "backupsTexto": "Cópias de segurança do restaurante atual.",
          "seguro": "Segurança",
          "usuariosTexto": "Crie garçons, gerentes e contas de acesso.",
          "equipo": "Equipe",
          "suscripcion": "Assinatura",
          "suscripcionTexto": "Teste, pagamento mensal e situação fiscal.",
          "primerosPasos": "Primeiros passos",
          "primerosPasosTexto": "Guia rápido para preparar o restaurante.",
          "guia": "Guia",
          "manual": "Manual",
          "manualTexto": "Manual de uso para o cliente.",
          "ayuda": "Ajuda",
          "gratisVida": "Grátis para sempre",
          "activa": "Ativa",
          "trialActivo": "Teste ativo",
          "pendientePago": "Pagamento pendente",
          "cancelada": "Cancelada",
          "administrador": "Administrador",
          "gerente": "Gerente",
          "camarero": "Garçom",
          "soloCreador": "Somente criador",
          "panelCreador": "Painel do Criador",
          "panelCreadorTexto": "Gerencie clientes SaaS, testes, assinaturas, dados fiscais, backups e ações administrativas."
    }
  };
