...
function textosDestinosImpresion(idiomaValor) {
  ...
  const textos = {
    ...
    "pt-br": {
          "lang": "pt-BR",
          "destinosComanda": "Destinos das comandas",
          "descripcionDestinos": "Defina para onde cada comanda é enviada: bar, cozinha, pizzaria, churrasqueira, coquetelaria ou outros postos de trabalho.",
          "volverConfiguracion": "Voltar às configurações",
          "productos": "Produtos",
          "impresion": "Impressão",
          "crearDestinoPersonalizado": "Criar destino personalizado",
          "nombre": "Nome",
          "placeholderDestino": "Churrasqueira, Coquetelaria, Bar do terraço...",
          "crearDestino": "Criar destino",
          "destinosDisponibles": "Destinos disponíveis",
          "destino": "Destino",
          "tipo": "Tipo",
          "estado": "Status",
          "accion": "Ação",
          "baseSistema": "Padrão do sistema",
          "personalizado": "Personalizado",
          "activo": "Ativo",
          "desactivado": "Desativado",
          "baseNoEliminar": "Não pode ser excluído. Está sempre disponível para uma configuração rápida.",
          "activar": "Ativar",
          ...
          "nombreNoValido": "Nome inválido",
          "destinoCreado": "Destino criado",
          "destinoActivado": "Destino ativado",
          "destinoDesactivado": "Destino desativado",
          "centroImpresion": "Central de impressão",
          "descripcionImpresion": "Configure o comprovante, bar, cozinha e todos os destinos de comandas deste restaurante.",
          "destinos": "Destinos",
          "abrirPos": "Abrir POS",
          "ticketCaja": "Comprovante / caixa",
          "nombreImpresora": "Nome / IP / referência da impressora",
          "placeholderImpresora": "Ex.: EPSON bar, 192.168.1.50...",
          "modo": "Modo",
          "modoGeneral": "Modo geral",
          "modoImpresionGeneral": "Modo geral de impressão",
          "modoPreview": "Visualização / janela",
          "modoArchivoTxt": "Arquivo TXT",
          "modoEscposRed": "Futuro ESC/POS em rede",
          "modoCentroImpresion": "Central de impressão",
          "probar": "Testar",
          "verUltimaPrueba": "Ver último teste",
          "guardarCentroImpresion": "Salvar central de impressão",
          "centroImpresionGuardado": "Central de impressão salva com sucesso",
          "noGenerarPrueba": "Não foi possível gerar o teste",
          "pruebaGenerada": "Teste gerado em",
          "sinPruebaGenerada": "Ainda não foi gerado nenhum teste para este destino.",
          "prueba": "TESTE",
          "etiquetaDestino": "DESTINO",
          "etiquetaHora": "HORA",
          "productoPrueba": "1 x PRODUTO DE TESTE",
          "pruebaCorrecta": "Se você consegue ver isto, o teste foi gerado corretamente.",
          "localeFecha": "pt-BR",
          "sinPermisos": "Você não tem permissão para configurar destinos e impressão."
    }
  };
