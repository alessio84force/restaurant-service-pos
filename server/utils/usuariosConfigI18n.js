...
function textosUsuariosConfig(idiomaValor) {
  ...
  const textos = {
    ...
    "pt-br": {
          "lang": "pt-BR",
          "usuarios": "Usuários",
          "descripcionUsuarios": "Crie e gerencie usuários somente deste restaurante.",
          "volverConfiguracion": "Voltar às configurações",
          "abrirPos": "Abrir POS",
          "crearUsuario": "Criar usuário",
          "usuariosRestaurante": "Usuários do restaurante",
          "usuario": "Usuário",
          "nombre": "Nome",
          "email": "E-mail",
          "contrasena": "Senha",
          "nuevaContrasena": "Nova senha",
          "placeholderContrasena": "Deixe em branco para manter a senha atual",
          "rol": "Função",
          "estado": "Status",
          "editar": "Editar",
          "guardar": "Salvar",
          ...
          "eliminar": "Excluir",
          "confirmarEliminar": "Excluir este usuário?",
          "activo": "Ativo",
          "desactivado": "Desativado",
          "sinUsuarios": "Ainda não há usuários.",
          "noEliminarPropio": "Você não pode excluir seu próprio usuário.",
          "rolAdmin": "Administrador",
          "rolGerente": "Gerente",
          "rolCamarero": "Garçom",
          "rolCocina": "Cozinha",
          "rolBar": "Bar",
          "sinPermisos": "Você não tem permissão para acessar estas configurações.",
          "noAutenticado": "Não autenticado",
          "noPrepararContrasena": "Não foi possível preparar a senha.",
          "faltanDatos": "Faltam informações obrigatórias",
          "emailExistente": "Já existe um usuário com este e-mail",
          "usuarioCreado": "Usuário criado com sucesso",
          "usuarioNoRestaurante": "Usuário não encontrado para este restaurante",
          "otroEmailExistente": "Já existe outro usuário com este e-mail",
          "necesitaAdminActivo": "Deve permanecer pelo menos um administrador ou gerente ativo",
          "usuarioActualizado": "Usuário atualizado com sucesso",
          "usuarioNoEncontrado": "Usuário não encontrado",
          "noDesactivarPropio": "Você não pode desativar seu próprio usuário enquanto estiver conectado",
          "estadoActualizado": "Status do usuário atualizado com sucesso",
          "noEliminarPropioSesion": "Você não pode excluir seu próprio usuário enquanto estiver conectado",
          "usuarioEliminado": "Usuário excluído permanentemente"
    }
  };
